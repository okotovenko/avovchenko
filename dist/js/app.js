(() => {
    ...
    let formValidate = {
        ...
        addTrue(formRequiredItem) {
            formRequiredItem.classList.add("_form-true");
            formRequiredItem.parentElement.classList.add("_form-true");
            let inputTrue = formRequiredItem.parentElement.querySelector(".form__true");
            if (inputTrue) formRequiredItem.parentElement.removeChild(inputTrue);
        },
 ...
 */
    ...
    var im = new Inputmask("99 9999 999 99");
    im.mask(selector);
    class ScrollWatcher {
        constructor(props) {
            let defaultConfig = {
    ...
    function foolScrennBlockForMobile() {
